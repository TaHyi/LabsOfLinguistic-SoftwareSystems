...
$conn = new DB_CONNECT();
    ...
    $sql="SELECT Card_Type_ID,Card_Type FROM $tbl_name ";
...
<body>
	...
	<div id="head">
         <header>
           <h2 > MANAGE CARD TYPE</h2>
             <ul class="list" style="margin-top: 50px; ">
                 <li style=" font-size: 14px;"><a style="color: #3366FF" href="home.php"><b>HOME</b></a></li>
                 <li style=" font-size: 14px;"><a style="color: #3366FF" href="addcardtype.php"><b>ADD CARD TYPE</b></a></li>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                        <table >
                            <tr >
                                ...
                                echo "\t\t<td style='padding:4px'><b><h3>Card Type</h3></b></td>";
                                echo "\t</tr>\n";
                                    // Printing results in HTML
                                    while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                        $id = $line['Card_Type_ID'];
                                        echo "\t<tr>\n";
                                        foreach ($line as $col_value) {
                                            echo "\t\t<td style='padding:4px'>$col_value</td>";
                                        }
                                        echo "\t\t<td style='padding:4px'><a href='editcardtype.php?id=$id'>Edit Record $id </a></td>\n";
                                        echo "\t</tr>\n";
                                    }
                                    // Free resultset
