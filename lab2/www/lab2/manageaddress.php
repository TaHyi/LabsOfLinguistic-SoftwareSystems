...
$conn = new DB_CONNECT();
    ...
    $sql="SELECT Address_ID,Address,City,State,Zip_Code,Country FROM $tbl_name ";
...
<head>
	<title>MANAGE CUSTOMERS ADDRESSES</title>
...
<body>
	...
	<div id="head">
         <header>
           <h2 > MANAGE CUSTOMERS ADDRESSES</h2>
             <ul class="list" style="margin-top: 50px; ">
                 <li style=" font-size: 14px;"><a style="color: #3366FF" href="home.php"><b>HOME</b></a></li>
                 <li style=" font-size: 14px;"><a style="color: #3366FF" href="addaddress.php"><b>ADD CUSTOMERS ADDRESSES</b></a></li>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                        <table >
                            <tr >
                                ...
                                echo "\t\t<td style='padding:4px'><b><h3>Address</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>City</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>State</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>Zip Code</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>Country</h3></b></td>";
                                echo "\t</tr>\n";
                                    ...
                                    while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                        ...
                                        echo "\t\t<td style='padding:4px'><a href='editaddress.php?id=$id'>Edit Record $id </a></td>\n";
                                        echo "\t</tr>\n";
                                    }
                                    // Free resultset
