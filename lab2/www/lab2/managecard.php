...
$conn = new DB_CONNECT();
    ...
    $sql="SELECT Card_ID,Card_Reg_Date,Account_ID,Card_Type_ID FROM $tbl_name ";
         ...
         <header>
           <h2 > MANAGE CARDS</h2>
             <ul class="list" style="margin-top: 50px; ">
                 ...
                 <li style=" font-size: 14px;"><a style="color: #3366FF" href="addcard.php"><b>ADD CARDS</b></a></li>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                        <table >
                            <tr >
                                <?php
                                echo "\t<tr>\n";
                                echo "\t\t<td style='padding:4px'><b><h3>Card ID</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>Card Reg Date</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>Account ID</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>Card Type ID</h3></b></td>";
                                echo "\t</tr>\n";
                                    ...
                                    while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                        ...
                                        echo "\t\t<td style='padding:4px'><a href='editcard.php?id=$id'>Edit Record $id </a></td>\n";
                                        echo "\t</tr>\n";
                                    }
                                    // Free resultset
