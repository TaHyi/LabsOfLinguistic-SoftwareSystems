...
$sql="SELECT * FROM $tbl_name WHERE Card_Type_ID='$id'";
        ...
        <tr><td bgcolor="blue" style='width: 850px'>
                <table cellpadding='0' cellspacing='5px' border='5px' width='100%'>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                            <form method="post" action="editcardtypeaction.php?id=<?php echo $id ?>" name="addbankaccount" target="_top" onsubmit="return validateAdmin()">
                                <table >
                                    <tr >
                                    ...
                                    <tr>
                                        <td style="padding:4px" ><font face="verdana,arial" size=2>Card Type </font></td>
                                        <td ><input type="text" name="txtCardType" size="21" value='<?php echo "{$line['Card_Type']}";?>' ></td>
                                    </tr>
                                    <tr ></tr >
                                    <tr >
                                        <td>&nbsp;</td>
                                        <td style="padding:4px" ><input style="padding:4px" type="submit" value="Save">
                                            <input style="padding:4px" type="button" value="Delete" name="btnDelete" onclick="javascript:location.href='delcardtype.php?id=<?php echo $id ?>'">
                                            <input style="padding:4px" type="button" value="Cancel" name="btnCancel" onclick="javascript:location.href='managecardtype.php'"></td>
                                    </tr>
