...
$conn = new DB_CONNECT();
    ...
    $sql="SELECT Transaction_ID,Account_ID,Transaction_Type_ID,Transaction_Date_Time,Transaction_Amount FROM $tbl_name ";
         ...
         <header>
           <h2 > MANAGE TRANSACTIONS</h2>
             <ul class="list" style="margin-top: 50px; ">
                 ...
                 <li style=" font-size: 14px;"><a style="color: #3366FF" href="addtransaction.php"><b>ADD TRANSACTION</b></a></li>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                        <table >
                            <tr >
                                <?php
                                echo "\t<tr>\n";
                                echo "\t\t<td style='padding:4px'><b><h3>Transaction ID</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>Account ID</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>Transaction Type ID</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>Transaction Date Time</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>Transaction Amount</h3></b></td>";
                                echo "\t</tr>\n";
                                    ...
                                    while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                        ...
                                        echo "\t\t<td style='padding:4px'><a href='edittransaction.php?id=$id'>Edit Record $id </a></td>\n";
                                        echo "\t</tr>\n";
                                    }
                                    // Free resultset
