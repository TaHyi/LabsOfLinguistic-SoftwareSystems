...
$sql="SELECT * FROM $tbl_name WHERE Transaction_Type_ID='$id'";
...
<div id="head">
    <header>
        <h2 > EDIT/DELETE TRANSACTION TYPE </h2>
        ...
        <tr><td bgcolor="blue" style='width: 850px'>
                <table cellpadding='0' cellspacing='5px' border='5px' width='100%'>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                            <form method="post" action="edittransactiontypeaction.php?id=<?php echo $id ?>" name="addbankaccount" target="_top" onsubmit="return validateAdmin()">
                                <table >
                                    <tr >
                                    ...
                                    <tr>
                                        <td style="padding:4px" ><font face="verdana,arial" size=2>Transaction Type</font></td>
                                        <td ><input type="text" name="txtTransactionType" size="21" value='<?php echo "{$line['Transaction_Type']}";?>' ></td>
                                    </tr>
                                    ...
                                    <tr >
                                        ...
                                        <td style="padding:4px" ><input style="padding:4px" type="submit" value="Save">
                                            <input style="padding:4px" type="button" value="Delete" name="btnDelete" onclick="javascript:location.href='deltransactiontype.php?id=<?php echo $id ?>'">
                                            <input style="padding:4px" type="button" value="Cancel" name="btnCancel" onclick="javascript:location.href='managetransactiontype.php'"></td>
                                    </tr>
