...
<body>
	...
	<div id="head">
         <header>
           <h2 >ADD BANK ACCOUNT TO THE DATABASE </h2>
                ...
                <table cellpadding='0' cellspacing='5px' border='5px' width='100%'>
                    <tr>
                        ...
                        <tr><td bgcolor=#eee style="padding:8px"><br>
                            <form method="post" action="bankaccountaction.php" name="bankaccount" target="_top" >

                                    <table >
                                        <tr >
                                            <td style="padding:4px" ><font face="verdana,arial" size=2>Account ID </font></td>
                                            <td  ><input type="text" name="txtAccountID" size="21"></td>

                                        </tr>
                                        <tr>
                                            <td style="padding:4px" ><font face="verdana,arial" size=2> Customer ID </font></td>
                                            <td style="size:160" ><input type="text" name="txtCustomerID" size="21" ></td>
                                        </tr>
                                        <tr>
                                            <td style="padding:4px" ><font face="verdana,arial" size=2>Status </font></td>
                                            <td style="size:160" ><input type="text" name="txtStatus" size="21" ></td>
                                        </tr>
                                        <tr>
                                            <td style="padding:4px" ><font face="verdana,arial" size=2>Account Type ID</font></td>
                                            <td><input type="text" name="txtAccountTypeID" size="21" value=""></td>
                                        </tr>
                                        <tr>
                                            <td style="padding:4px" ><font face="verdana,arial" size=2>Current Balance</font></td>
                                            <td><input type="text" name="txtCurrentBalance" size="21"></td>
                                        </tr>
                                        <tr >
                                            <td>&nbsp;</td>
                                            <td style="padding:4px"><input style="padding:4px" type="submit" value="Save">
                                            <input style="padding:4px" type="button" value="Cancel" name="btnCancel" onclick="javascript:location.href='manageadmin.php'"></td>
                                        </tr>
                                        <tr>
                                            <td colspan=2>&nbsp;</td>
                                        </tr>
