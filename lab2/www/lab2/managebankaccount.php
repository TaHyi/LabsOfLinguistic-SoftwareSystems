...
$conn = new DB_CONNECT();
    ...
    $sql="SELECT Account_ID,Customer_ID,Status,Account_Type_ID,Current_Balance FROM $tbl_name ";
         ...
         <header>
           <h2 > MANAGE BANK ACCOUNTS</h2>
             <ul class="list" style="margin-top: 50px; ">
                 ...
                 <li style=" font-size: 14px;"><a style="color: #3366FF" href="addabankaccount.php"><b>ADD BANK ACCOUNTS</b></a></li>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                        <table >
                            <tr >
                                ...
                                echo "\t\t<td style='padding:4px'><b><h3>Status</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>Account Type ID</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>Current Balance</h3></b></td>";
                                echo "\t</tr>\n";
                                    ...
                                    while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                        ...
                                        echo "\t\t<td style='padding:4px'><a href='editbankaccount.php?id=$id'>Edit Record $id </a></td>\n";
                                        echo "\t</tr>\n";
                                    }
                                    // Free resultset
