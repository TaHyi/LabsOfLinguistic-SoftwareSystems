...
$sql="SELECT * FROM $tbl_name WHERE Transaction_ID='$id'";
        ...
        <tr><td bgcolor="blue" style='width: 850px'>
                <table cellpadding='0' cellspacing='5px' border='5px' width='100%'>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                            <form method="post" action="edittransactionaction.php?id=<?php echo $id ?>" name="addbankaccount" target="_top" onsubmit="return validateAdmin()">
                                <table >
                                    <tr >
                                        <td style="padding:4px"><font face="verdana,arial" size=2>Transaction ID </font></td>
                                        <td  ><input type="text" name="txtTransactionID" size="21" value='<?php echo "{$line['Transaction_ID']}";?>'></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="padding:4px"><font face="verdana,arial" size=2 >Transaction Type ID </font></td>
                                        <td ><input type="text" name="txtTransactionTypeID" size="21" value='<?php echo "{$line['Transaction_Type_ID']}";?>' ></td>
                                    </tr>
                                    <tr>
                                        <td style="padding:4px"><font face="verdana,arial" size=2 >Transaction Amount</font></td>
                                        <td><input type="text" name="txtTransactionAmount" size="21" value='<?php echo "{$line['Transaction_Amount']}";?>'></td>
                                    </tr>
                                    ...
                                    <tr >
                                        ...
                                        <td style="padding:4px" ><input style="padding:4px" type="submit" value="Save">
                                            <input style="padding:4px" type="button" value="Delete" name="btnDelete" onclick="javascript:location.href='deltransaction.php?id=<?php echo $id ?>'">
                                            <input style="padding:4px" type="button" value="Cancel" name="btnCancel" onclick="javascript:location.href='managetransaction.php'"></td>
                                    </tr>
