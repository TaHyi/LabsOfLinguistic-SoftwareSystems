...
<body>
	...
	<div id="head">
         <header>
           <h2 >ADD CARD TO THE DATABASE </h2>
                ...
                <table cellpadding='0' cellspacing='5px' border='5px' width='100%'>
                    <tr>
                        ...
                        <tr><td bgcolor=#eee style="padding:8px"><br>
                            <form method="post" action="addcardaction.php" name="bankaccount" target="_top" >

                                    <table >
                                        <tr >
                                            <td style="padding:4px" ><font face="verdana,arial" size=2>Card ID </font></td>
                                            <td  ><input type="text" name="txtCardID" size="21"></td>

                                        </tr>
                                        <tr>
                                            <td style="padding:4px" ><font face="verdana,arial" size=2>Card Reg Date </font></td>
                                            <td style="size:160" ><input type="text" name="txtCardRegDate" size="21" ></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="txtCardTypeID" size="21" value=""></td>
                                        </tr>
