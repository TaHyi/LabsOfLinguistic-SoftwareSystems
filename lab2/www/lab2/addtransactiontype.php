...
<body>
	...
	<div id="head">
         <header>
           <h2 >ADD TRANSACTION TYPE TO THE DATABASE </h2>
                ...
                <table cellpadding='0' cellspacing='5px' border='5px' width='100%'>
                    <tr>
                        ...
                        <tr><td bgcolor=#eee style="padding:8px"><br>
                            <form method="post" action="addtransactiontypeaction.php" name="bankaccount" target="_top" >

                                    <table >
                                        <tr >
                                            <td style="padding:4px" ><font face="verdana,arial" size=2>Transaction Type ID </font></td>
                                            <td  ><input type="text" name="txtTransactionTypeID" size="21"></td>

                                        </tr>
                                        <tr>
                                            <td style="padding:4px" ><font face="verdana,arial" size=2>Transaction Type </font></td>
                                            <td style="size:160" ><input type="text" name="txtTransactionType" size="21" ></td>
                                        </tr>
